...
class ComponentsControllerTest < ActionController::TestCase
  ...
  test "should create component" do
    assert_difference('Component.count') do
      post :create, component: { remarks: @component.remarks, size: @component.size, type: @component.type }
    end
  ...
  test "should update component" do
    patch :update, id: @component, component: { remarks: @component.remarks, size: @component.size, type: @component.type }
    assert_redirected_to component_path(assigns(:component))
  end
